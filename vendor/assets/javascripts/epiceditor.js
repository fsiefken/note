  ...
  function EpicEditor(options) {
    ...
    var self = this
      ...
      , defaults = { container: 'epiceditor'
        ...
        , theme: { base: window.location.protocol + '//' + window.location.host + '/epiceditor' + '/themes/base/epiceditor.css'
          , preview: window.location.protocol + '//' + window.location.host + '/epiceditor' + '/themes/preview/github.css'
          , editor: window.location.protocol + '//' + window.location.host + '/epiceditor' + '/themes/editor/epic-dark.css'
          }
        , focusOnLoad: false
